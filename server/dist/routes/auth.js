 ...
 *
 */
router.post('/login', (0, validate_1.validate)(yup_1.login), auth_1.authController.login);
/**
 * @swagger
 * /auth/edituser:
 *   patch:
 ...
 */
router.patch('/edituser', auth_2.isAuth, (0, validate_1.validate)(yup_1.editUser), auth_1.authController.editUser);
/**
 * @swagger
 * /auth/logout:
 *   post:
 ...
 *               $ref: '#/components/schemas/ValidationErrors'
 */
router.post('/signup', (0, validate_1.validate)(yup_1.signup), auth_1.authController.signup);
/**
 * @swagger
 * /auth/isloggedin:
 *   get:
