 ...
 *
 */
router.post('/add', auth_1.isAuth, (0, validate_1.validate)(yup_1.addProductCart), validObjectId_1.validObjectId, productExist_1.productExist, checkStock_1.checkStock, cart_1.cartController.addProducts);
/**
 * @swagger
 * /cart/delete/{id}:
 *   delete:
