 ...
 */
router.post('/add', auth_1.isAuth, (0, validate_1.validate)(yup_1.addProduct), products_1.productController.addProduct);
/**
 * @swagger
 * /products/update/{id}:
 *   patch:
 ...
 */
router.patch('/update/:id', auth_1.isAuth, productExist_1.productExist, (0, validate_1.validate)(yup_1.editProduct), products_1.productController.updateProduct);
/**
 * @swagger
 *
 * /products/delete/{id}:
