...
var checkStock = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, productId, quantity, findById, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, product_1.productModel.get(productId)];
            case 1:
                findById = (_b.sent())[0];
                ...
                return [2 /*return*/, res.status(404).json({
                        error: 'The product is out of stock or you are trying to add more than we have in stock right now',
                    })];
